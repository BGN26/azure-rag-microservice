...
class AnalyticsEngine:
    ...
    def get_kpis(self):
        ...
        success_rate = (
            len(self.df[self.df["status"] == "success"]) / total_documents
        ) * 100
        ...
        avg_time_dept = (
            self.df.groupby("department")["processing_time_sec"]
            .mean()
            .round(2)
            .to_dict()
        )
        ...
        tokens_by_doc = (
            self.df.groupby("document_type")["tokens_consumed"].sum().to_dict()
        )
